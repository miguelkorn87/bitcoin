Miguelkoin Core version 0.10.4 is now available from:

  <https://miguelkoin.org/bin/miguelkoin-core-0.10.4/>
...
- #6953 `43c2789` Split miguelkoin-tx into its own package
- #6953 `dfe0d4d` Include miguelkoin-tx binary on Debian/Ubuntu
