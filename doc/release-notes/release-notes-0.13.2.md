Miguelkoin Core version 0.13.2 is now available from:

  <https://miguelkoin.org/bin/miguelkoin-core-0.13.2/>
...
- #8908 `4a974b2` Update miguelkoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow miguelkoin-tx to create v2 transactions (mkndrak)
