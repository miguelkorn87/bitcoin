Miguelkoin Core version 0.9.2.1 is now available from:

  https://miguelkoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MKN to 0.01 MKN
...
- Fix "Start miguelkoin on system login"
