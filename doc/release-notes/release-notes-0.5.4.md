Miguelkoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/miguelkoin/files/Miguelkoin/miguelkoin-0.5.4/
...
http://gitorious.org/miguelkoin/miguelkoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Miguelkoin-Qt notifications under Growl 1.3.
Increase required age of Miguelkoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMiguelkoin properly when installing Miguelkoin-Qt over it. (Windows)
