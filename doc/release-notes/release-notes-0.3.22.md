Download URL: https://sourceforge.net/projects/miguelkoin/files/Miguelkoin/miguelkoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MKN fee schedule (users still pay 0.01 MKN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #miguelkoin00 - #miguelkoin99
