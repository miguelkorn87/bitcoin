Miguelkoin Core version 0.9.4 is now available from:

  https://miguelkoin.org/bin/0.9.4/
...
this update is incompatible with the Miguelkoin system and could lead to consensus
forks.

Miguelkoin Core released binaries from https://miguelkoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~miguelkoin/+archive/ubuntu/miguelkoin
- A third-party or self-compiled Miguelkoin Core

upgrade to Miguelkoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
