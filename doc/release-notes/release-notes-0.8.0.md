Miguelkoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/miguelkoin/files/Miguelkoin/miguelkoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Miguelkoin
...
New/changed settings (command-line or miguelkoin.conf file)
--------------------------------------------------------
