...
This document provides guidelines for internationalization of the Miguelkoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `miguelkoin_en.ts` remains unchanged.
