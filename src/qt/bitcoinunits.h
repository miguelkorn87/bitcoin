...
#ifndef MIGUELKOIN_QT_MIGUELKOINUNITS_H
#define MIGUELKOIN_QT_MIGUELKOINUNITS_H
...
/** Miguelkoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MiguelkoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MiguelkoinUnits(QObject *parent);

    /** Miguelkoin units.
      @note Source: https://en.miguelkoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MKN,
...
typedef MiguelkoinUnits::Unit MiguelkoinUnit;

#endif // MIGUELKOIN_QT_MIGUELKOINUNITS_H
