...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MiguelkoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_miguelkoin-qt -platform xcb      # Linux
//     src/qt/test/test_miguelkoin-qt -platform windows  # Windows
//     src/qt/test/test_miguelkoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = MiguelkoinUnits::formatWithUnit(unit, balance, false, MiguelkoinUnits::separatorAlways);
    ...
    // Amount input
    MiguelkoinAmountField* amountInput = receiveCoinsDialog.findChild<MiguelkoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: miguelkoin:")) != -1);
