/* src/config/miguelkoin-config.h.  Generated from miguelkoin-config.h.in by configure.  */
/* src/config/miguelkoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MIGUELKOIN_CONFIG_H

#define MIGUELKOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Miguelkoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Miguelkoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/miguelkoin/miguelkoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Miguelkoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Miguelkoin Core 0.16.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "miguelkoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://miguelkoincore.org/"
