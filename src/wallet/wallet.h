...
#ifndef MIGUELKOIN_WALLET_WALLET_H
#define MIGUELKOIN_WALLET_WALLET_H
...
public:
     ...
     * on this miguelkoin node, and set to 0 for transactions that were created
...
#endif // MIGUELKOIN_WALLET_WALLET_H
