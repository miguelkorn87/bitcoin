...
#ifndef MIGUELKOIN_TEST_SCRIPTNUM10_H
#define MIGUELKOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Miguelkoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MIGUELKOIN_TEST_BIGNUM_H
