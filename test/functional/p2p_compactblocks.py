...
# TestP2PConn: A peer we use to send messages to miguelkoind, and store responses.
...
class CompactBlocksTest(MiguelkoinTestFramework):
    ...
    # This test actually causes miguelkoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that miguelkoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for miguelkoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # miguelkoind will not send blocktxn responses for blocks whose height is
