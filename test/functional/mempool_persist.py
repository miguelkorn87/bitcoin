...
By default, miguelkoind will dump mempool on shutdown and
...
class MempoolPersistTest(MiguelkoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give miguelkoind a second to reload the mempool
        ...
        self.log.debug("Prevent miguelkoind from writing mempool.dat to disk. Verify that `savemempool` fails")
